...
$P(No Inf|T-)=\frac{P(T-|No Inf) \times P(No Inf)}{P(T-|No Inf) \times P(No Inf) + P(T-|Inf) \times P(Inf)}$
`r unhide()`
...
Let's see how the specificity might effect that probability of no infection given a negative test.
